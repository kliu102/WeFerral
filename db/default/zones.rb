eu_vat = Heron::Zone.create!(name: "EU_VAT", description: "Countries that make up the EU VAT zone.")
north_america = Heron::Zone.create!(name: "North America", description: "USA + Canada")
